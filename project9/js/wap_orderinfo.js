...
/***/ function(module, exports, __webpack_require__) {
	...
	function pageInit(wap_inputs) {
	        ...
	        for (var key in component) {
	            if (_jquery2.default.type(component[key]) == "array") {
	                ...
	                arr.forEach(function (input) {
	                    ...
	                    (0, _jquery2.default)("#" + currentCompId).append(inputObj);
	                    returnObj.push({
	                        "id": input.id,
	                        "label": input.lable
	                    });
	    ...
	    (0, _jquery2.default)(".wapInsure").click(function () {
	        for (var i = 0; i < returnObj.length; i++) {
	            var item = returnObj[i];
	            var value = (0, _jquery2.default)("#" + item.id).val();
	            if (value == "") {
	                alert(item.label + "为空");
	                return false;
	            }
	        ...
	        sessionStorage.setItem("returnMessage", (0, _stringify2.default)(returnMessage));
...
/***/ function(module, exports) {
	...
	module.exports = {
		"wapInputs": [
			{
				"componentId": "wapApplicantInfo",
				"componentTitle": "投保人信息",
				"applicantInfo": [
					{
						"componentId": "wapApplicantName",
						"id": "applicantName",
						"lable": "姓名",
						"tip": "投保人姓名",
						"description": "请输入投保人姓名",
						"required": true,
						"defaultValue": "",
						"type": "",
						"options": ""
					...
					{
						"componentId": "wapApplicantId",
						"id": "applicantId",
						"lable": "身份证",
						"tip": "投保人身份证",
						"description": "请输入投保人身份证",
						"required": true,
						"defaultValue": "",
						"type": "",
						"options": ""
					...
					{
						"componentId": "wapApplicantPhone",
						"id": "applicantPhone",
						"lable": "手机号",
						"tip": "投保人手机号",
						"description": "请输入投保人手机号",
						"required": true,
						"defaultValue": "",
						"type": "",
						"options": ""
					...
					{
						"componentId": "wapApplicantEmail",
						"id": "applicantEmail",
						"lable": "邮箱",
						"tip": "投保人邮箱",
						"description": "请输入投保人邮箱",
						"required": true,
						"defaultValue": "",
						"type": "",
						"options": ""
			...
			{
				"componentId": "wapBeneficiaryInfo",
				"componentTitle": "受益人信息",
				"beneficiaryInfo": [
					{
						"componentId": "wapInsuredRelationship",
						"id": "insuredRelationship",
						"lable": "受益人",
						"tip": "被保险人是投保人",
						"description": "请选择被保险人和投保人关系",
						"required": true,
						"defaultValue": "",
						"type": "",
						"options": ""
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./wapApplicantId": 10,
		"./wapApplicantId.html": 10,
		"./wapApplicantInfo": 11,
		"./wapApplicantInfo.html": 11,
		"./wapApplicantName": 12,
		"./wapApplicantName.html": 12,
		"./wapApplicantPhone": 13,
		"./wapApplicantPhone.html": 13,
		"./wapApplicantProfession": 14,
		"./wapApplicantProfession.html": 14,
		"./wapBeneficiaryInfo": 15,
		"./wapBeneficiaryInfo.html": 15,
		"./wapInsuredEmail": 16,
		"./wapInsuredEmail.html": 16,
		"./wapInsuredId": 17,
		"./wapInsuredId.html": 17,
		"./wapInsuredInfo": 18,
		"./wapInsuredInfo.html": 18,
		"./wapInsuredName": 19,
		"./wapInsuredName.html": 19,
		"./wapInsuredPhone": 20,
		"./wapInsuredPhone.html": 20,
		"./wapInsuredRelationship": 21,
		"./wapInsuredRelationship.html": 21,
		"./wapPayOrderinfo": 22,
		"./wapPayOrderinfo.html": 22,
		"./wapPayWays": 23,
		"./wapPayWays.html": 23
	};
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"list\">\r\n    <ul class=\"item\" id=\"wapApplicantInfo\">\r\n    </ul>\r\n</div>\r\n";
...
/***/ function(module, exports) {
	...
	module.exports = "<li>\r\n    <h3>职业类别</h3>\r\n    <p class=\"selarea\"><select class=\"c2\"><option value=\"0\">请选择</option></select><span class=\"icon-arr2\"></span></p>\r\n</li>\r\n";

/***/ },
/* 15 */
/***/ function(module, exports) {

	module.exports = "<div class=\"list tm10\">\r\n    <ul class=\"item\" id=\"wapBeneficiaryInfo\">\r\n\r\n    </ul>\r\n</div>\r\n";
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"list tm10\">\r\n    <ul class=\"item\" id=\"wapInsuredInfo\">\r\n    </ul>\r\n</div>\r\n";
