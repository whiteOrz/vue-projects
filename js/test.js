...
window.onload = function() {
    ...
    for (var i = 0; i < j.length; i++) {
        var img = $("<img/>");
        img.attr("src", "http://whzt.taikang.com/brazil/static/images/jiang/" +
            j[i] + ".png");
        ...
        $.post(getEgg, {
            ...
            if (res.code == 0) {
                ...
                if (res.content == 0) {
                    ...
                    $(".cai_power").addClass(
                        "hideDiv");
                    $(".cai_gife").removeClass(
                        "hideDiv");
                    if (eml == "E") {
                        $(".cai_gife")
                            .css(
                                "background",
                                'url(http://whzt.taikang.com/brazil/static/images/caidan/' +
                                res.content +
    ...
    $(".submit_btn").on("tap", function() {
        ...
        var test2 = new RegExp(
            "[`~!@#$^&()=|{}':;',\\[\\].<>/?~！@#￥……&（）—|{}——【】‘；：”“'。，、？]"); // 姓名正则
        if (test1.test(userName) || test2.test(userName)) {
            massage("姓名不能包含特殊字符");
            return false;
        }
        ...
        var test3 = /\d+/g;
        var test4 = /\w/g;
        if (test3.test(userName) || test4.test(userName)) {
            massage("姓名不能包含数字或字母");
            return false;
        }
    ...
    if (login_flag == 0) { // 首次进入
        ...
        if (sites == 1) {
            ...
            $(".yadian_click").off("tap").addClass("yadianh").removeClass(
                "yadianw");
            ...
            $(".beij_click").off("tap").addClass("beijh").removeClass("beijw");
            $(".liyue_click").off("tap").addClass("liyueh").removeClass(
                "liyuen");
