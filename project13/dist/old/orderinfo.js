...
/***/ function(module, exports, __webpack_require__) {
	...
	var plan = getMessage.plan || "",
	    ...
	    proposalToken = sessionStorage.getItem("proposalToken") || "",
	    duties = sessionStorage.getItem("duties") || "",
	    metadata_scope = "pc",
			...
			_jquery2.default.ajax({
				...
				success: function success(msg) {
					if (msg.code == "0") {
						...
						sessionStorage.setItem("proposalNo", (0, _stringify2.default)(proposalNo));
						sessionStorage.setItem("proposalToken", (0, _stringify2.default)(proposalToken));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var plan = getMessage.plan || "",
	    ...
	    metadata_scope = "pc",
	    platform = "pc",
	    proposalNo = JSON.parse(sessionStorage.getItem("proposalNo")) || "",
	    proposalToken = sessionStorage.getItem("proposalToken") || "",
				...
				_jquery2.default.ajax({
					...
					success: function success(msg) {
						if (msg.code == "0") {
							...
							sessionStorage.setItem("tradeId", (0, _stringify2.default)(tradeId));
							sessionStorage.setItem("tradeToken", (0, _stringify2.default)(tradeToken));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var productAge = sessionStorage.getItem("productAge");
